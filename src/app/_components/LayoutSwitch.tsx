...
export default () => {
    ...
    return (
        <div className="flex gap-y-1 gap-x-2 items-start sm:items-center">
            <svg className={`${layout === "grid" ? "opacity-25" : ""} size-7 transition-opacity`} aria-label="Affichage en liste" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
            ...
            <svg className={`${layout === "list" ? "opacity-25" : ""} size-7 transition-opacity`} aria-label="Affichage en grille" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
